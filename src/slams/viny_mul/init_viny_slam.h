...
#include "viny_mul_map.h"

//using VinySlam = SingleStateHypothesisLaserScanGridWorld<RescalableCachingGridMap<UnboundedPlainGridMap> >;
using VinySlam = SingleStateHypothesisLaserScanGridWorld<UnboundedPlainGridMapWithScan >;
