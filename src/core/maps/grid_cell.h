...
public:
  ...
  virtual void merge (const GridCell& another) {
    _occupancy.prob_occ =
        (this->_occupancy.prob_occ + another._occupancy.prob_occ)/2;

    _occupancy.estimation_quality =
         (this->_occupancy.estimation_quality +
         another._occupancy.estimation_quality)/2;
  }
